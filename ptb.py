...
def build_datasets(args, create_test=True):
    """Build PTB dataset for training, evaluation and test.
    """
    splits = ['train', 'valid'] + (['test'] if create_test else [])
...
def create_dataloader(datasets, args):
    """Create data loaders.
    """
    loaders = OrderedDict()
    batch_sizes = {
